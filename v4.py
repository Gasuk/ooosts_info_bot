...
import os
from config import MAIN_TEXT, RESPONSES, TRANSPORT_OPTIONS, MAP_IMAGES, TRANSPORT_LIST, MENU_OPTIONS, TRANSPORT_DIRECTIONS, number, help_text, main_help_text
...
def help(message):
    bot.send_message(message.chat.id, main_help_text, parse_mode="HTML")
